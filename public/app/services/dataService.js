(function() {
    angular.module('app')
        .factory('dataService',['logger', '$q', '$timeout', '$http', 'constants', '$cacheFactory', dataService]);
    ...
    function dataService(logger, $q, $timeout, $http, constants, $cacheFactory) {
        ...
        function sendGetBooksError(response) {
            return $q.reject('Error retreiving book(s).: ' + response.status);
        }
        ...
        function updateBookError(response) {
            return $q.reject('Error updating book(s).: ' + response.status);
        }
